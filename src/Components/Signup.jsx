...
import {
    TextField,makeStyles,Grid,Button,Card,CardContent,CardActions,Container,CardMedia,Typography
                ...
                <Grid container className={classes.alignCenter} spacing={2}>
                    <Grid item xs={12} sm={5}>
                        <Card variant="outlined">
                            ...
                            />
                            <CardContent>
                                <Typography style={{textAlign:"center",color:'darkgrey'}} variant="subtitle2">
                            ...
                            <CardContent className={classes.centerElements}>
                                ...
                                <TextField id="outlined-basic" label="Password" type="password" variant="outlined" value={password} size="small" display="block"
                                    className={classes.mb}
                            ...
                            <CardActions>
                                <Button 
                                    ...
                                    startIcon={<CloudUploadIcon style={{color:'red'}}></CloudUploadIcon>}>
                                    <Typography style={{color:"red"}}>Upload Profile Image</Typography>
                                    <input type="file" accept="image/*" onChange={(e)=>{handleFileSubmit(e)}} hidden>
                                    </input>
                                </Button>
                            </CardActions>
                            <CardActions>
                                <Button variant="contained" display="block" style={{backgroundColor:'#0095f6',color:'white'}}
                                onClick={handleSignup} disabled={loader} className={classes.width80}>Sign up
                                </Button>
                            </CardActions>
                            <CardContent>
