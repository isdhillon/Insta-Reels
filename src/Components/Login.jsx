...
import{TextField,makeStyles,Grid,Button,Paper,Card,CardContent,CardActions,Container,CardMedia,Typography} from '@material-ui/core'
          ...
          <Grid item xs={12} sm={5}>
            <Card variant="outlined" style={{marginTop:"8rem"}}>
              ...
              <CardContent className={classes.centerElements}>
                <TextField id="outlined-basic" label="email" type="email" variant="outlined" value={email} size="small" 
                ...
                />
                <LinkButton content="Forget Password?"
                route="/signup">
